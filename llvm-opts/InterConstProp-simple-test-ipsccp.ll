; ModuleID = 'InterConstProp-simple-test-m2r.ll'
...
entry:
  %call = call i32 @get_ten()
  %call1 = call i32 @add(i32 noundef 10, i32 noundef 5)
  ret i32 %call1
}
...
entry:
  ...
  %call3 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef 10, i32 noundef 20, i32 noundef %call2)
  ret i32 0
}
